...
######################################## DASHBOARD ########################################
    ...
    with st.container():
        ...
        with st.expander('GRÁFICOS DE PRODUCTIVIDAD'):
            ...
            well_prod_press.update_layout(hovermode="x unified", margin={"r":0,"t":100,"l":100,"b":0}, xaxis=dict(title_text="<b>Año</b>", nticks=25, domain=[0.25, 0.8]),
                ...
                yaxis2=dict(nticks=30, exponentformat='none', title="<b>Agua [SBPD]</b>", titlefont=dict(color="black", size=10), tickfont=dict(color="black", size=9),
                        anchor="free",
                        overlaying="y",
                        side="left",
                        position=0.15),
