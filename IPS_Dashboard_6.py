...
######################################## DASHBOARD ########################################
    ...
    with st.container():
        ...
        with st.expander('GRÁFICOS DE PRODUCTIVIDAD'):
            ...
            well_prod_press.update_layout(title_text=f'HISTÓRICO DE PRODUCCIÓN {filt_pozos}', height=400, width=1250, font=dict(family="sans-serif", size=10, color="black"), legend=dict(orientation="h", yanchor="bottom", y=1, xanchor="right", x=0.9))
            well_prod_press.update_layout(hovermode="x unified", margin={"r":0,"t":50,"l":0,"b":0}, xaxis=dict(title_text="<b>Año</b>", nticks=25, domain=[0.15, 0.85]),
                yaxis=dict(nticks=20, exponentformat='none', title="Aceite [SBPD]", titlefont=dict(color="black", size=12), tickfont=dict(color="black", size=9)),
                ...
                yaxis3=dict(nticks=20, exponentformat='none', title="Gas [MMPCPD]", titlefont=dict(color="black", size=12), tickfont=dict(color="black", size=9),
                        ...
                        overlaying="y",
                        side="right"),
                yaxis4=dict(nticks=20,exponentformat='none', title="Presión [Kg/cm2]", titlefont=dict(color="black", size=12), tickfont=dict(color="black", size=9),
                        anchor="free",
                        overlaying="y",
                        side="right",
                        position=0.92))
            ...
            raa_rga_plot.update_layout(hovermode="x unified", margin={"r":0,"t":100,"l":100,"b":0}, xaxis=dict(title_text="<b>Año</b>", nticks=25, domain=[0, 0.95]),
                ...
                yaxis3=dict(nticks=20, exponentformat='none', title="Corte de Agua [%]", titlefont=dict(color="black", size=12), tickfont=dict(color="black", size=9),
                    ...
                    side="right",
                    position=0.95),
                yaxis4=dict(nticks=20,exponentformat='none', title="RAA [sm3/sm3]", titlefont=dict(color="black", size=12), tickfont=dict(color="black", size=9),
                    anchor="free",
                    overlaying="y",
                    side="right",
                    position=1))
