...
######################################## DASHBOARD ########################################
    ...
    with st.container():
        ...
        with st.expander('GRÁFICOS DE PRODUCTIVIDAD'):
            ...
            well_prod_press.update_layout(title_text=f'HISTÓRICO DE PRODUCCIÓN {filt_pozos}', height=350, width=1150, font=dict(family="sans-serif", size=10, color="black"), legend=dict(orientation="h", yanchor="bottom", y=1, xanchor="right", x=1))
