...
######################################## DASHBOARD ########################################
    ...
    with st.container():
        ...
        with st.expander('GRÁFICOS DE PRODUCTIVIDAD'):
            ...
            w_prod_plot.update_layout(title_text = f'Histórico de producción {filt_pozos}', hovermode="x unified", font=dict(family="sans-serif", size=15, color="black"), legend=dict(orientation="h", yanchor="bottom", y=1, xanchor="right", x=1), margin={"r":0,"t":100,"l":0,"b":0}, height=500, width=1230)
