...
######################################## DASHBOARD ########################################
    ...
    with st.container():
        ...
        with st.expander('GRÁFICOS DE PRODUCTIVIDAD'):
            ...
            well_prod_press.update_layout(title_text=f'HISTÓRICO DE PRODUCCIÓN {filt_pozos}', height=400, width=1350, font=dict(family="sans-serif", size=10, color="black"), legend=dict(orientation="h", yanchor="bottom", y=1, xanchor="right", x=1))
            well_prod_press.update_layout(hovermode="x unified", margin={"r":0,"t":100,"l":0,"b":0}, xaxis=dict(title_text="<b>Año</b>", nticks=25, domain=[0.15, 0.8]),
